...
class Session(object):
    ...
    _client_protocol_handler = ProtocolHandler
    ...
    @property
    def client_protocol_handler(self):
        """
        ...
        """
        return self._client_protocol_handler

    @client_protocol_handler.setter
    def client_protocol_handler(self, value):
        self._client_protocol_handler = value
        self._protocol_handler = self._client_protocol_handler(
